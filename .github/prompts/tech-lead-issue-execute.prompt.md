...
2. **ADR Preflight** — For any architecture-impacting issue:
   - Read `docs/architecture/ADRs.md` and relevant ADRs first.
   - Record impacted ADR IDs, required ADR updates, or explicit no-impact statement.

3. **Codebase Reconnaissance** — Use workspace search and file-reading tools directly to:
...
4. **Task Decomposition** — Break the issue into atomic, agent-assignable sub-tasks:
...
8. **Closure** — Summarize what was done:
   ...
   - ADR impact and updates (or explicit no-impact statement)
